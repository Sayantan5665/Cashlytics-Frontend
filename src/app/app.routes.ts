...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'expenses/category-wise', loadComponent: () => import('./users/category-wise-expense-list/category-wise-expense-list.component').then((c) => c.CategoryWiseExpenseListComponent) },
